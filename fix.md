...
- [x] **SYS-04: 3x-ui v3.0.2 Update Path** (Инструкция по обновлению панели предоставлена пользователю).
- [x] **SYS-04: Port 443 Conflict Identification** (Выявлен конфликт: Reality занимает порт 443. Рекомендовано использование Fallback на 127.0.0.1:3005 вместо прямой установки Nginx на 443).
- [x] **SYS-05: 3x-ui Update Path** (Добавлена инструкция по обновлению панели до актуальной версии через официальный инсталлер).
