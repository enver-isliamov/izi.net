      ...
      <div className="w-full max-w-4xl space-y-8 animate-in fade-in duration-500">
        ...
        <Card className="glass-card border-primary/20">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <p>
              1.1. Наш сервис предоставляет пользователям доступ к цифровому контенту и панели управления в личном кабинете.
            </p>
            <p className="text-primary/90 font-medium">
              1.2. В соответствии с мировой практикой реализации цифровых услуг, услуга (предоставление неэксклюзивного права использования панели управления) считается полностью оказанной, надлежащего качества и потребленной Пользователем в ту же секунду, когда Пользователь получает доступ к личному кабинету или когда система успешно генерирует данные (ключи) для доступа.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-primary/20">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>
              4.2. <strong>Куда обращаться:</strong> Для оформления возврата необходимо связаться со службой поддержки путем отправки запроса в Telegram-бот <a href={`https://t.me/${import.meta.env.VITE_TELEGRAM_BOT_NAME || 'izinet_bot'}`} className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">@{import.meta.env.VITE_TELEGRAM_BOT_NAME || 'izinet_bot'}</a>, либо на электронную почту (если она доступна в личном кабинете). К обращению обязательно прикрепите подтверждение (чек) об оплате, информацию о вашем Email-аккаунте и описание проблемы (например, выписку о двойном списании).
            </p>
            <p>
        ...
        <Card className="glass-card border-primary/20">
          <CardHeader>
            <CardTitle>5. Как производится возврат</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <p>
              5.1. При одобрении заявки техническим отделом, средства возвращаются исключительно на ту же банковскую карту или тот же платежный счет, с которого была произведена исходная оплата. 
            </p>
            <p>
              5.2. <strong>Сроки зачисления:</strong> Процедура зачисления средств может занимать от <strong>5 до 30 рабочих дней</strong> с момента подтверждения возврата с нашей стороны. Данный срок зависит исключительно от регламентов работы вашего банка-эмитента и платежной системы (ENOT.io).
            </p>
          </CardContent>
        </Card>
