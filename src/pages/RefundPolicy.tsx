      ...
      <div className="w-full max-w-4xl space-y-8 animate-in fade-in duration-500">
        ...
        <Card className="glass-card border-primary/20">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            <p>
              1.1. Наш сервис предоставляет пользователям доступ к цифровому контенту, программному обеспечению и панели управления в личном кабинете.
            </p>
            <p className="text-primary/90 font-medium">
              1.2. В соответствии с характером цифрового контента, предоставляемого в нематериальной форме, услуга считается полностью оказанной, надлежащего качества и принятой Пользователем в момент предоставления доступа к функционалу личного кабинета (генерации ключей, отображения настроек/файлов). С этого момента обязательства Сервиса считаются выполненными в полном объеме за весь оплаченный период.
            </p>
          </CardContent>
        </Card>
