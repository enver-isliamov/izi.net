      ...
      <div className="w-full max-w-4xl space-y-8 animate-in fade-in duration-500">
        ...
        <Card className="glass-card border-primary/20">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>
              5.2. В случае поступления уведомления о Chargeback по транзакции, по которой услуга была предоставлена, личный кабинет Пользователя блокируется навсегда без права восстановления, а данные о нарушении могут быть переданы в межбанковские скоринговые системы и платежным агрегаторам (ENOT.io).
            </p>
          </CardContent>
        </Card>
