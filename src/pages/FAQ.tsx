...
const faqs = [
  {
    ...
    a: "Мы принимаем оплату банковскими картами (МИР, Visa, Mastercard, любых банков РФ), через Систему Быстрых Платежей (СБП) через надежный шлюз Platega, а также популярными криптовалютами (через Cryptomus) и Telegram Stars."
  },
  {
    category: 'Рефералы',
