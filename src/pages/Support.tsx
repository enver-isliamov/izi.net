...
const faqs = [
  ...
  },
  {
    ...
    a: "По умолчанию в тариф включено 1 устройство. Вы можете добавить дополнительные устройства (до 10 штук) при оформлении подписки или позже в личном кабинете."
  },
  {
