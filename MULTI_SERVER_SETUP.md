...
-- 8. Инициализация ключей Cloudflare и Enot.io (необязательно, можно сразу вводить из админки)
...
2. Добавьте ваш текущий VPN-сервер (YOUR_VPS_IP) в список.
3. В разделе "Настройки" укажите ваши ключи API Cloudflare и нажмите "Сохранить".
4. С помощью интерактивного инструмента **«Привязка домена в 2 клика»** выберите ваш загруженный домен, укажите субдомен и привяжите его к любому VPN-серверу или к самой панели за пару секунд абсолютно бесшовно!
